...
if ($searchDesignFormContainer.length != 0) {
    ...
    $('#submitButton').on('click', function(event) {
        ...
        const baseUrl = 'https://44.194.81.95:5000';
        ...
        axios({
                ...
                method: 'get',
                url: baseUrl + '/api/user/processSearchUser/1/' + searchInput,
            })
    ...
    function clickHandlerForPageButton(event) {
        ...
        axios({
                ...
                method: 'get',
                url: baseUrl + '/api/user/processSearchUser/' + pageNumber + '/' + searchInput,
            })
            .then(function(response) {
                //Using the following to inspect the response.data data structure
                //before deciding the code which dynamically generates cards.
